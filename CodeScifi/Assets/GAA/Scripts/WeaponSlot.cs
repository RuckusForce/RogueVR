...
public class WeaponSlot : MonoBehaviour
{
    ...
    //Scroll through instantiated weapons? This one would be more centralized
    //Or just use the data instead?
    ...
    {//knows which gameobject is being dragged
        ...
        {//if this slot has something, and it's not the same place it came from
